...
DECLARE @step_name varchar(1000) = N'execute MSDB parser';
DECLARE @command varchar(1000) = N'c:\Admin\SqlServerUtilities.exe';
DECLARE @output_file_name varchar(1000) = N'C:\admin\MSDB_log.txt';
