...
--#region BR Dim.DischargeDispositionLookupCOM
SET @UpdatedBy = 'VCH\GCrowell'
SET @CreatedBy ='VCH\GCrowell'
SET @IsActive = 1;
SET @IsLogged = 1;
SET @GUID = '7a57f650-77c7-11e6-8af9-00232444dba2'
...
FROM Dim.DischargeDispositionLookupCOM
...
EXEC [dbo].[SetBizRule] 
@pBRId=@BRID, 
@pShortNameOfTest='Dim.DischargeDispositionLookupCOM', 
@pRuleDesc='', 
@pConditionSQL='', 
@pActionID=, 
...
--#endregion BR Dim.DischargeDispositionLookupCOM
