...
--#region BR Dim.WaitlistType
SET @UpdatedBy = 'VCH\GCrowell'
SET @CreatedBy ='VCH\GCrowell'
SET @IsActive = 1;
SET @IsLogged = 1;
SET @GUID = '7a0da4f8-77c7-11e6-ab03-00232444dba2'
...
FROM Dim.WaitlistType

END
'
EXEC [dbo].[SetBizRule] 
@pBRId=@BRID, 
@pShortNameOfTest='Dim.WaitlistType', 
@pRuleDesc='', 
@pConditionSQL='', 
@pActionID=, 
