...
--#region BR Dim.ReasonEndingServiceLookup
SET @UpdatedBy = 'VCH\GCrowell'
SET @CreatedBy ='VCH\GCrowell'
SET @IsActive = 1;
SET @IsLogged = 1;
SET @GUID = '7a5696b6-77c7-11e6-b399-00232444dba2'
...
FROM Dim.ReasonEndingServiceLookup
...
EXEC [dbo].[SetBizRule] 
@pBRId=@BRID, 
@pShortNameOfTest='Dim.ReasonEndingServiceLookup', 
@pRuleDesc='', 
@pConditionSQL='', 
@pActionID=, 
...
--#endregion BR Dim.ReasonEndingServiceLookup
