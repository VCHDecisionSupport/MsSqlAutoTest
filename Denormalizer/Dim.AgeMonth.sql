...
--#region BR Dim.AgeMonth
SET @UpdatedBy = 'VCH\GCrowell'
SET @CreatedBy ='VCH\GCrowell'
SET @IsActive = 1;
SET @IsLogged = 1;
SET @GUID = '7a3cf390-77c7-11e6-b6cd-00232444dba2'
...
FROM Dim.AgeMonth
JOIN Dim.Age
ON Dim.Age.AgeID=Dim.AgeMonth.AgeID
END
'
EXEC [dbo].[SetBizRule] 
@pBRId=@BRID, 
@pShortNameOfTest='Dim.AgeMonth', 
@pRuleDesc='', 
@pConditionSQL='', 
@pActionID=, 
