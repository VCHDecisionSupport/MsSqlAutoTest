...
--#region BR Dim.WaitlistOfferOutcome
SET @UpdatedBy = 'VCH\GCrowell'
SET @CreatedBy ='VCH\GCrowell'
SET @IsActive = 1;
SET @IsLogged = 1;
SET @GUID = '7a352b2c-77c7-11e6-878f-00232444dba2'
...
FROM Dim.WaitlistOfferOutcome

END
'
EXEC [dbo].[SetBizRule] 
@pBRId=@BRID, 
@pShortNameOfTest='Dim.WaitlistOfferOutcome', 
@pRuleDesc='', 
@pConditionSQL='', 
@pActionID=, 
...
--#endregion BR Dim.WaitlistOfferOutcome
