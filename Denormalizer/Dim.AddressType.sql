...
--#region BR Dim.AddressType
SET @UpdatedBy = 'VCH\GCrowell'
SET @CreatedBy ='VCH\GCrowell'
SET @IsActive = 1;
SET @IsLogged = 1;
SET @GUID = '7a871dd2-77c7-11e6-b044-00232444dba2'
...
FROM Dim.AddressType

END
'
EXEC [dbo].[SetBizRule] 
@pBRId=@BRID, 
@pShortNameOfTest='Dim.AddressType', 
@pRuleDesc='', 
@pConditionSQL='', 
@pActionID=, 
