...
--#region BR Dim.WaitlistReasonNotOffered
SET @UpdatedBy = 'VCH\GCrowell'
SET @CreatedBy ='VCH\GCrowell'
SET @IsActive = 1;
SET @IsLogged = 1;
SET @GUID = '7a1a2868-77c7-11e6-95f5-00232444dba2'
...
FROM Dim.WaitlistReasonNotOffered

END
'
EXEC [dbo].[SetBizRule] 
@pBRId=@BRID, 
@pShortNameOfTest='Dim.WaitlistReasonNotOffered', 
@pRuleDesc='', 
@pConditionSQL='', 
@pActionID=, 
...
--#endregion BR Dim.WaitlistReasonNotOffered
