...
--#region BR Dim.WaitlistClientOfferStatus
SET @UpdatedBy = 'VCH\GCrowell'
SET @CreatedBy ='VCH\GCrowell'
SET @IsActive = 1;
SET @IsLogged = 1;
SET @GUID = '7a6febba-77c7-11e6-a6c8-00232444dba2'
...
FROM Dim.WaitlistClientOfferStatus

END
'
EXEC [dbo].[SetBizRule] 
@pBRId=@BRID, 
@pShortNameOfTest='Dim.WaitlistClientOfferStatus', 
@pRuleDesc='', 
@pConditionSQL='', 
@pActionID=, 
...
--#endregion BR Dim.WaitlistClientOfferStatus
