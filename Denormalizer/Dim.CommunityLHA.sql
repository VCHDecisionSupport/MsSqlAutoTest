...
--#region BR Dim.CommunityLHA
SET @UpdatedBy = 'VCH\GCrowell'
SET @CreatedBy ='VCH\GCrowell'
SET @IsActive = 1;
SET @IsLogged = 1;
SET @GUID = '7a6256d2-77c7-11e6-bfd0-00232444dba2'
...
FROM Dim.CommunityLHA

END
'
EXEC [dbo].[SetBizRule] 
@pBRId=@BRID, 
@pShortNameOfTest='Dim.CommunityLHA', 
@pRuleDesc='', 
@pConditionSQL='', 
@pActionID=, 
