...
--#region BR Dim.ServiceProviderCategoryLookup
SET @UpdatedBy = 'VCH\GCrowell'
SET @CreatedBy ='VCH\GCrowell'
SET @IsActive = 1;
SET @IsLogged = 1;
SET @GUID = '7a69f824-77c7-11e6-a554-00232444dba2'
...
FROM Dim.ServiceProviderCategoryLookup

END
'
EXEC [dbo].[SetBizRule] 
@pBRId=@BRID, 
@pShortNameOfTest='Dim.ServiceProviderCategoryLookup', 
@pRuleDesc='', 
@pConditionSQL='', 
@pActionID=, 
...
--#endregion BR Dim.ServiceProviderCategoryLookup
