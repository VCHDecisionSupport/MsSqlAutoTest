...
--#region BR Dim.ReferralPriority
SET @UpdatedBy = 'VCH\GCrowell'
SET @CreatedBy ='VCH\GCrowell'
SET @IsActive = 1;
SET @IsLogged = 1;
SET @GUID = '7a68988c-77c7-11e6-bcf4-00232444dba2'
...
FROM Dim.ReferralPriority

END
'
EXEC [dbo].[SetBizRule] 
@pBRId=@BRID, 
@pShortNameOfTest='Dim.ReferralPriority', 
@pRuleDesc='', 
@pConditionSQL='', 
@pActionID=, 
...
--#endregion BR Dim.ReferralPriority
