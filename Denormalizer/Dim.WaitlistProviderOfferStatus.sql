...
--#region BR Dim.WaitlistProviderOfferStatus
SET @UpdatedBy = 'VCH\GCrowell'
SET @CreatedBy ='VCH\GCrowell'
SET @IsActive = 1;
SET @IsLogged = 1;
SET @GUID = '7a51dba6-77c7-11e6-8914-00232444dba2'
...
FROM Dim.WaitlistProviderOfferStatus

END
'
EXEC [dbo].[SetBizRule] 
@pBRId=@BRID, 
@pShortNameOfTest='Dim.WaitlistProviderOfferStatus', 
@pRuleDesc='', 
@pConditionSQL='', 
@pActionID=, 
...
--#endregion BR Dim.WaitlistProviderOfferStatus
