...
--#region BR dbo.HCRSRAIHighRiskSummary
SET @UpdatedBy = 'VCH\GCrowell'
SET @CreatedBy ='VCH\GCrowell'
SET @IsActive = 1;
SET @IsLogged = 1;
SET @GUID = '7a7ee03e-77c7-11e6-8862-00232444dba2'
...
BEGIN
	SELECT
	GenderID
FROM dbo.HCRSRAIHighRiskSummary
JOIN Dim.Gender
ON Dim.Gender.GenderID=dbo.HCRSRAIHighRiskSummary.GenderID
END
'
EXEC [dbo].[SetBizRule] 
@pBRId=@BRID, 
@pShortNameOfTest='dbo.HCRSRAIHighRiskSummary', 
@pRuleDesc='', 
@pConditionSQL='', 
@pActionID=, 
...
--#endregion BR dbo.HCRSRAIHighRiskSummary
