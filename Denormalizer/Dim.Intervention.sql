...
--#region BR Dim.Intervention
SET @UpdatedBy = 'VCH\GCrowell'
SET @CreatedBy ='VCH\GCrowell'
SET @IsActive = 1;
SET @IsLogged = 1;
SET @GUID = '7a477b24-77c7-11e6-9b0e-00232444dba2'
...
EXEC [dbo].[SetBizRule] 
@pBRId=@BRID, 
@pShortNameOfTest='Dim.Intervention', 
@pRuleDesc='', 
@pConditionSQL='', 
@pActionID=, 
