...
--#region BR Dim.MethodOfSubstanceIntake
SET @UpdatedBy = 'VCH\GCrowell'
SET @CreatedBy ='VCH\GCrowell'
SET @IsActive = 1;
SET @IsLogged = 1;
SET @GUID = '7a859728-77c7-11e6-8ee1-00232444dba2'
...
FROM Dim.MethodOfSubstanceIntake

END
'
EXEC [dbo].[SetBizRule] 
@pBRId=@BRID, 
@pShortNameOfTest='Dim.MethodOfSubstanceIntake', 
@pRuleDesc='', 
@pConditionSQL='', 
@pActionID=, 
...
--#endregion BR Dim.MethodOfSubstanceIntake
