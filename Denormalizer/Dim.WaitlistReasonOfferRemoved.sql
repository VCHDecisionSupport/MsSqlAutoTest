...
--#region BR Dim.WaitlistReasonOfferRemoved
SET @UpdatedBy = 'VCH\GCrowell'
SET @CreatedBy ='VCH\GCrowell'
SET @IsActive = 1;
SET @IsLogged = 1;
SET @GUID = '7a5955e6-77c7-11e6-af53-00232444dba2'
...
FROM Dim.WaitlistReasonOfferRemoved

END
'
EXEC [dbo].[SetBizRule] 
@pBRId=@BRID, 
@pShortNameOfTest='Dim.WaitlistReasonOfferRemoved', 
@pRuleDesc='', 
@pConditionSQL='', 
@pActionID=, 
...
--#endregion BR Dim.WaitlistReasonOfferRemoved
