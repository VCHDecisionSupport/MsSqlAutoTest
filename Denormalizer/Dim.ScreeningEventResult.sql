...
--#region BR Dim.ScreeningEventResult
SET @UpdatedBy = 'VCH\GCrowell'
SET @CreatedBy ='VCH\GCrowell'
SET @IsActive = 1;
SET @IsLogged = 1;
SET @GUID = '7a6cde68-77c7-11e6-8195-00232444dba2'
...
FROM Dim.ScreeningEventResult

END
'
EXEC [dbo].[SetBizRule] 
@pBRId=@BRID, 
@pShortNameOfTest='Dim.ScreeningEventResult', 
@pRuleDesc='', 
@pConditionSQL='', 
@pActionID=, 
...
--#endregion BR Dim.ScreeningEventResult
