...
--#region BR Dim.ReasonEndingService
SET @UpdatedBy = 'VCH\GCrowell'
SET @CreatedBy ='VCH\GCrowell'
SET @IsActive = 1;
SET @IsLogged = 1;
SET @GUID = '7a279642-77c7-11e6-a463-00232444dba2'
...
FROM Dim.ReasonEndingService

END
'
EXEC [dbo].[SetBizRule] 
@pBRId=@BRID, 
@pShortNameOfTest='Dim.ReasonEndingService', 
@pRuleDesc='', 
@pConditionSQL='', 
@pActionID=, 
...
--#endregion BR Dim.ReasonEndingService
