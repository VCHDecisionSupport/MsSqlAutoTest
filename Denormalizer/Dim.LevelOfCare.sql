...
--#region BR Dim.LevelOfCare
SET @UpdatedBy = 'VCH\GCrowell'
SET @CreatedBy ='VCH\GCrowell'
SET @IsActive = 1;
SET @IsLogged = 1;
SET @GUID = '7a88a480-77c7-11e6-86c7-00232444dba2'
...
FROM Dim.LevelOfCare

END
'
EXEC [dbo].[SetBizRule] 
@pBRId=@BRID, 
@pShortNameOfTest='Dim.LevelOfCare', 
@pRuleDesc='', 
@pConditionSQL='', 
@pActionID=, 
