...
--#region BR Dim.DischargeOutcome
SET @UpdatedBy = 'VCH\GCrowell'
SET @CreatedBy ='VCH\GCrowell'
SET @IsActive = 1;
SET @IsLogged = 1;
SET @GUID = '7a36b1d4-77c7-11e6-a3ad-00232444dba2'
...
FROM Dim.DischargeOutcome

END
'
EXEC [dbo].[SetBizRule] 
@pBRId=@BRID, 
@pShortNameOfTest='Dim.DischargeOutcome', 
@pRuleDesc='', 
@pConditionSQL='', 
@pActionID=, 
...
--#endregion BR Dim.DischargeOutcome
