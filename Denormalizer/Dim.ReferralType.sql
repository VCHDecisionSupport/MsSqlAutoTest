...
--#region BR Dim.ReferralType
SET @UpdatedBy = 'VCH\GCrowell'
SET @CreatedBy ='VCH\GCrowell'
SET @IsActive = 1;
SET @IsLogged = 1;
SET @GUID = '7a4be810-77c7-11e6-8b1c-00232444dba2'
...
FROM Dim.ReferralType

END
'
EXEC [dbo].[SetBizRule] 
@pBRId=@BRID, 
@pShortNameOfTest='Dim.ReferralType', 
@pRuleDesc='', 
@pConditionSQL='', 
@pActionID=, 
