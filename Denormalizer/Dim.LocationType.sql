...
--#region BR Dim.LocationType
SET @UpdatedBy = 'VCH\GCrowell'
SET @CreatedBy ='VCH\GCrowell'
SET @IsActive = 1;
SET @IsLogged = 1;
SET @GUID = '7a18c8d0-77c7-11e6-a788-00232444dba2'
...
FROM Dim.LocationType

END
'
EXEC [dbo].[SetBizRule] 
@pBRId=@BRID, 
@pShortNameOfTest='Dim.LocationType', 
@pRuleDesc='', 
@pConditionSQL='', 
@pActionID=, 
