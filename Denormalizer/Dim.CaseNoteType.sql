...
--#region BR Dim.CaseNoteType
SET @UpdatedBy = 'VCH\GCrowell'
SET @CreatedBy ='VCH\GCrowell'
SET @IsActive = 1;
SET @IsLogged = 1;
SET @GUID = '7a8a2b28-77c7-11e6-b653-00232444dba2'
...
FROM Dim.CaseNoteType

END
'
EXEC [dbo].[SetBizRule] 
@pBRId=@BRID, 
@pShortNameOfTest='Dim.CaseNoteType', 
@pRuleDesc='', 
@pConditionSQL='', 
@pActionID=, 
