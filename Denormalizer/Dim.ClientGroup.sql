...
--#region BR Dim.ClientGroup
SET @UpdatedBy = 'VCH\GCrowell'
SET @CreatedBy ='VCH\GCrowell'
SET @IsActive = 1;
SET @IsLogged = 1;
SET @GUID = '7a0f0492-77c7-11e6-88f8-00232444dba2'
...
FROM Dim.ClientGroup

END
'
EXEC [dbo].[SetBizRule] 
@pBRId=@BRID, 
@pShortNameOfTest='Dim.ClientGroup', 
@pRuleDesc='', 
@pConditionSQL='', 
@pActionID=, 
