...
SET @IsActive = 1;
SET @IsLogged = 1;
SET @GUID = '7a156d5a-77c7-11e6-8440-00232444dba2'
SELECT @BRID=BRID FROM dbo.DQMF_BizRule WHERE GUID=@GUID

SET @ActionSQL = '
BEGIN
	SELECT
	WaitlistClientOfferStatusID
	,WaitlistOfferOutcomeID
	,WaitlistReasonNotOfferedID
...
JOIN dbo.WaitlistProviderOfferFact
...
JOIN Dim.WaitlistReasonRejected
