...
--#region BR Dim.ContactType
SET @UpdatedBy = 'VCH\GCrowell'
SET @CreatedBy ='VCH\GCrowell'
SET @IsActive = 1;
SET @IsLogged = 1;
SET @GUID = '7a2488ee-77c7-11e6-b94c-00232444dba2'
...
FROM Dim.ContactType

END
'
EXEC [dbo].[SetBizRule] 
@pBRId=@BRID, 
@pShortNameOfTest='Dim.ContactType', 
@pRuleDesc='', 
@pConditionSQL='', 
@pActionID=, 
