...
--#region BR Dim.SubstanceUseLookup
SET @UpdatedBy = 'VCH\GCrowell'
SET @CreatedBy ='VCH\GCrowell'
SET @IsActive = 1;
SET @IsLogged = 1;
SET @GUID = '7a1d35be-77c7-11e6-9c7e-00232444dba2'
...
FROM Dim.SubstanceUseLookup

END
'
EXEC [dbo].[SetBizRule] 
@pBRId=@BRID, 
@pShortNameOfTest='Dim.SubstanceUseLookup', 
@pRuleDesc='', 
@pConditionSQL='', 
@pActionID=, 
...
--#endregion BR Dim.SubstanceUseLookup
