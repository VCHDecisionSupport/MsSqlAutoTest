...
--#region BR Dim.CommunityServiceLocation
SET @UpdatedBy = 'VCH\GCrowell'
SET @CreatedBy ='VCH\GCrowell'
SET @IsActive = 1;
SET @IsLogged = 1;
SET @GUID = '7a1211e6-77c7-11e6-b679-00232444dba2'
...
FROM Dim.CommunityServiceLocation

END
'
EXEC [dbo].[SetBizRule] 
@pBRId=@BRID, 
@pShortNameOfTest='Dim.CommunityServiceLocation', 
@pRuleDesc='', 
@pConditionSQL='', 
@pActionID=, 
...
--#endregion BR Dim.CommunityServiceLocation
