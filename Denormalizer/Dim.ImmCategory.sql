...
--#region BR Dim.ImmCategory
SET @UpdatedBy = 'VCH\GCrowell'
SET @CreatedBy ='VCH\GCrowell'
SET @IsActive = 1;
SET @IsLogged = 1;
SET @GUID = '7a7bf9fa-77c7-11e6-8f8b-00232444dba2'
...
FROM Dim.ImmCategory

END
'
EXEC [dbo].[SetBizRule] 
@pBRId=@BRID, 
@pShortNameOfTest='Dim.ImmCategory', 
@pRuleDesc='', 
@pConditionSQL='', 
@pActionID=, 
