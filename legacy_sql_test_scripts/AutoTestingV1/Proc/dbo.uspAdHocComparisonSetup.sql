...
BEGIN
	...
	EXEC TestLog.dbo.uspCreateQuerySnapShot @pQuery = @pPreEtlQuery, @pPkField = @pObjectPkColumns, @pDestTableName = @preSnapShotName
	...
	EXEC TestLog.dbo.uspCreateQuerySnapShot @pQuery = @pPostEtlQuery, @pPkField = @pObjectPkColumns, @pDestTableName = @postSnapShotName
