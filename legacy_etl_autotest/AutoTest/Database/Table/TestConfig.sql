...
CREATE TABLE dbo.TestConfig (
	...
	,PreEtlSourceObjectFullName varchar(200) NULL -- fully qualified name of table/view, null if Profile
	,PostEtlSourceObjectFullName varchar(200) NOT NULL -- fully qualified name of table/view 
	...
	,TestRuntimeSeconds int NULL -- time taken to create+populate snap shot table
